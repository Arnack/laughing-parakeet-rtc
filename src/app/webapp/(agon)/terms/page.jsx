                                ...
                                <div className="row">
                                    <div className="col-lg-2">
                                        <div className="table-of-content">
                                            ...
                                            <ul>
                                                <li>
                                                    <Link href="/webapp/terms#section-1" legacyBehavior><a>Limitation of Liability</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-2" legacyBehavior><a>Licensing Policy</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-3" legacyBehavior><a>Product Compatibility</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-4" legacyBehavior><a>Delivery</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-5" legacyBehavior><a>Ownership</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-6" legacyBehavior><a>Browser Compatibility</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-7" legacyBehavior><a>Updates</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-8" legacyBehavior><a>Template Support</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-9" legacyBehavior><a>Price Changes</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-10" legacyBehavior><a>Refund Policy</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-11" legacyBehavior><a>Email and Newsletter</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-12" legacyBehavior><a>License Agreement</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/webapp/terms#section-13" legacyBehavior><a>Severability</a></Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-lg-8">
                                        <div className="single-detail">
                                            {/* <img className="img-responsive bdr-16" src="/assets/imgs/page/blog/single/img-1.png" alt="" /> */}
                                            ...
                                            <p>We consider it our duty to offer a great experience across most major browsers, which is why our products support the latest modern web browsers including (but not limited to) Firefox, Safari, Chrome and Internet Explorer 9+. However, the performance may vary between different browsers, versions, and operating systems.</p>
                                            ...
                                            <p>By purchasing our product(s), you indicate and consent that you have read and agree to the Terms and Conditions listed and detailed on this page. We reserve the right to change or modify the current Terms and Conditions without prior notice or consent.</p>
